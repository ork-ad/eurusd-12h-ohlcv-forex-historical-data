...
**EURUSD 12h OHLCV Forex historical data** — ultra high-quality 12h OHLCV for **Euro / US Dollar**. 24/5 FX liquidity with Asian, European and US sessions — not limited to US market hours. Clean `time, open, high, low, close, volume` CSV for backtesting, algorithmic trading and quantitative research.
...
**[EURUSD_12h.csv](https://github.com/ork-ad/eurusd-12h-ohlcv-forex-historical-data/blob/main/EURUSD_12h.csv)** on GitHub ([raw CSV](https://raw.githubusercontent.com/ork-ad/eurusd-12h-ohlcv-forex-historical-data/main/EURUSD_12h.csv)) · [GitHub Releases](https://github.com/ork-ad/eurusd-12h-ohlcv-forex-historical-data/releases) when the release workflow is active.

## GitHub Pages

Interactive chart & stats: **[https://ork-ad.github.io/eurusd-12h-ohlcv-forex-historical-data/](https://ork-ad.github.io/eurusd-12h-ohlcv-forex-historical-data/)**
